---
url: https://ng-angular-stack.github.io/craft/guide/routing/guards.md
---
# Route guards
...
that has to be *fetched first*, suspend the composing guard with `craftUntilSettled` (or `craftUntilDefined`).
