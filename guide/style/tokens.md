---
url: https://craft-ts.github.io/craft/guide/style/tokens.md
---
...
an *optional* phantom on a primitive base — `'blabla'` stays assignable, every
...
drops it *silently* — the variable stops being registered, `var(--x)` resolves to
