---
url: https://ng-angular-stack.github.io/craft/guide/testing/craft-graph-vs-nx.md
---
# Craft graph vs Nx
...
| --- | --- | --- |
| `demo` imports `@craft-ng/core` | `yield* CheckoutApi` in the same app | `depends-on` |
